...
[![npm version](https://img.shields.io/npm/v/@toonamfjs/bytearray-node?style=flat-square)](https://www.npmjs.com/package/@toonamfjs/bytearray-node)
[![npm downloads](https://img.shields.io/npm/dm/@toonamfjs/bytearray-node?style=flat-square)](https://www.npmjs.com/package/@toonamfjs/bytearray-node)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)

A Node.js implementation of an ActionScript 3-style `ByteArray`,
providing a convenient, high-level API for reading and writing
binary data streams, with support for various primitive types,
strings, compression, and buffer management,
based on bytearray-node by Zaseth.
...
- **String support:**
    - Read/write UTF-8 strings and multibyte strings
      with custom character sets (using [iconv-lite](https://www.npmjs.com/package/iconv-lite))
- **Buffer stream API:**
...
- **Compression and decompression:**
    - Built-in support for `zlib` and `deflate`
      compression/decompression via Node.js
- **Buffer management:**
...
> **Note:**
> While the API is inspired by ActionScript 3's ByteArray,
